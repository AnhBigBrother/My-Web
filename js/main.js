        ...
        for (let j = 0; j < 9; j++) {
            ...
            if (x.value != "") {
                if (x.value == "0") {
                    ...
                    grid[i][j] = x.value;
                    x.style = "background-color:#1e8675;color:whitesmoke;";
                }
            }
            else { 
                grid[i][j] = "0"; 
                x.style = "background-color:#1d2432;color:#a5a5a5;";
            }
        }
    }
...
function showDescrip1() {
    document.getElementById("hobbydescr1").style.display = 'block';
}
function showDescrip2() {
    document.getElementById("hobbydescr2").style.display = 'block';
}
function showDescrip3() {
    document.getElementById("hobbydescr3").style.display = 'block';
}
function hideDescrip1() {
    document.getElementById("hobbydescr1").style.display = 'none';
}
function hideDescrip2() {
    document.getElementById("hobbydescr2").style.display = 'none';
}
function hideDescrip3() {
    document.getElementById("hobbydescr3").style.display = 'none';
}